...
import com.deileo.basketFinderJava.exception.BadRequestException;
import com.deileo.basketFinderJava.security.HttpCookieOAuth2AuthorizationRequestRepository;
import com.deileo.basketFinderJava.security.TokenProvider;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request.getCookies(), REDIRECT_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        ...
        List<String> list = appProperties.getOauth2().getAuthorizedRedirectUris();
